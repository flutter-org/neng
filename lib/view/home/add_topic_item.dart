...
class AddTopicItemPage extends StatefulWidget {

  int _topicId;

  AddTopicItemPage(this._topicId);

  @override
  State<StatefulWidget> createState() => _AddTopicItemPageState();

}

class _AddTopicItemPageState extends State<AddTopicItemPage> {
